  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center h-screen">
        ...
        {/* Images */}
        <div
          className="bg-white shadow-lg m-auto mt-24 rounded-[20px] w-[373px] h-auto"
          style={{ boxShadow: "2px 2px 100px 0 rgba(0,0,0,0.2)" }}
        >
          <img
            className="rounded-tl-[20px] rounded-tr-[20px] w-[375px] h-auto object-cover"
          ...
          <div className="flex flex-col justify-center items-center m-auto mt-4 w-[314px] h-[300px]">
            ...
            <div className="flex justify-between items-center m-auto w-[314px]">
              <div className="flex">
                ...
                <p className="text-black text-base text-left">Live Preview</p>
              </div>
              ...
              <div className="flex">
                ...
                <p className="text-black text-base text-left">View Code</p>
              </div>
            </div>
          </div>
        </div>
