...
const as = "sriman-portfolio/src/assets/products-app.png";
  ...
  const projects = [
    {
      title: "TV Shows",
      description:
        "This is a TV Shows app built with React, allowing users to browse and search for their favorite TV shows.",
      techStack: "React, HTML, JavaScript, CSS",
      livePreview: "https://fedevworks23.github.io/react-tvshows-app/",
      viewCode: "",
      image: "sriman-portfolio/src/assets/tv-shows-app.png",
    },
    {
      title: "Products App",
      description:
        " This is a Products App built with React, showcasing various products with details and images.",
      techStack: "React, HTML, JavaScript, CSS",
      livePreview: "https://fedevworks23.github.io/react-products-store/",
      viewCode: "",
      image: "sriman-portfolio/src/assets/products-app.png",
    },
  ];
  return (
    <>
      <div className="flex flex-col justify-center items-center h-screen">
        ...
        <div className="gap-15 grid grid-cols-3 mt-24">
          {projects.map((project, index) => (
            <div
              key={index}
              className="bg-white shadow-lg rounded-[20px] w-[350px] h-auto"
              style={{ boxShadow: "2px 2px 100px 0 rgba(0,0,0,0.2)" }}
            >
              <div className="flex justify-center items-center">
                <img
                  className="rounded-tl-[20px] rounded-tr-[20px] h-[277px] object-cover"
                  src={project.image}
                />
              </div>

              {/* Project Content */}
              <div className="flex flex-col justify-center items-center m-auto mt-4 w-[314px] h-[300px]">
                <p className="font-medium text-[28px] text-black text-center">
                  {project.title}
                </p>
                <p className="flex justify-center items-center m-auto w-[314px] font-light text-[#666] text-lg">
                  {project.description}
                </p>
                <p className="m-auto w-[314px]">
                  <span className="w-[314px] text-[#42446e] text-base text-left">
                    Tech stack :
                  </span>
                  <span className="w-[314px] font-light text-[#666] text-sm text-left">
                    {" "}
                  </span>
                  <span className="w-[314px] font-light text-[#42446e] text-sm text-left">
                    {project.techStack}
                  </span>
                </p>
                <div className="flex justify-between items-center m-auto w-[314px]">
                  <Link to={project.livePreview} target="_blank">
                    <div className="flex">
                      <svg
                        width={20}
                        height={20}
                  ...
                  <div className="flex">
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className="relative mr-2.5 w-5 h-5"
                      preserveAspectRatio="none"
                    >
